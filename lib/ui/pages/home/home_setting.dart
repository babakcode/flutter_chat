        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  ...
                  AppButtonTransparent(
                    ...
                    onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (context) => QrPage(token: auth.myUser?.publicToken ?? '')))),
                  AppButtonTransparent(
                    margin: EdgeInsets.zero,
              ...
              ListTile(
                onTap: () => auth.logOut(),
                tileColor: AppConstants.scaffoldLightBackground.withOpacity(.04),
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(24)),
